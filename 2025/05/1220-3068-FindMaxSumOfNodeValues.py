...
class Solution1:
    ...
    Runtime 218ms Beats 12.07%
    Memory 30.36MB Beats 17.24%
    """
    ...
    def maxSumOfNodes(self, index, isEven, nums, k, memo: List[List[int]]) -> int:
        if index == len(nums):
...
class Solution2:
    ...
    Runtime 131ms Beats 18.97%
    Memory 27.36MB Beats 17.24%
    """
...
class Solution3:
    ...
    Runtime 43ms Beats 63.79%
    Memory 26.16MB Beats 58.62%
    """
...
class Solution4:
    ...
    Runtime 29ms Beats 87.93%
    Memory 26.00MB Beats 70.69%
    """
