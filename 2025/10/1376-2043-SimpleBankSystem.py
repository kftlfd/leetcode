...
class Bank:
    """
    Runtime 44ms Beats 31.27%
    Memory 47.70MB Beats 48.72%
    """
    ...
    def transfer(self, account1: int, account2: int, money: int) -> bool:
        if not self._is_acc_valid(account1) or not self._is_acc_valid(account2):
            return False
    ...
    def deposit(self, account: int, money: int) -> bool:
        if not self._is_acc_valid(account):
            return False
    ...
    def _is_acc_valid(self, account: int) -> bool:
...
class Bank1:
    """
    leetcode solution
    Runtime 39ms Beats 43.37%
    Memory 47.65MB Beats 82.51%
    """
