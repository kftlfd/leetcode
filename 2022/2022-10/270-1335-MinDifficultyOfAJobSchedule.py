...
# Runtime: 1188 ms, faster than 79.06% of Python3 online submissions for Minimum Difficulty of a Job Schedule.
# Memory Usage: 14.8 MB, less than 57.75% of Python3 online submissions for Minimum Difficulty of a Job Schedule.
class Solution:
