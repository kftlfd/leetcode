...
# Runtime: 6030 ms, faster than 81.42% of Python3 online submissions for Maximum Score from Performing Multiplication Operations.
# Memory Usage: 22.5 MB, less than 99.19% of Python3 online submissions for Maximum Score from Performing Multiplication Operations.
class Solution:
