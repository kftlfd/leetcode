...
# Runtime: 116 ms, faster than 15.57% of Python3 online submissions for Bag of Tokens.
...
class Solution:
    def bagOfTokensScore(self, tokens: List[int], power: int) -> int:
        ...
        while tokens and (power >= tokens[0] or bns):
...
for t in tests:
    print(t)
    print(s.bagOfTokensScore(t[0], t[1]))
    print()
