...
class Solution1:
    """
    leetcode solution: Count Parity Prefixes
    Runtime: 1691 ms, faster than 19.23% of Python3 online submissions for Number of Wonderful Substrings.
    Memory Usage: 17.5 MB, less than 79.81% of Python3 online submissions for Number of Wonderful Substrings.
    """
