...
class Solution:
    """
    leetcode solution: Kruskal's algorithm
    Runtime: 1157 ms, faster than 62.63% of Python3 online submissions for Find Critical and Pseudo-Critical Edges in Minimum Spanning Tree.
    Memory Usage: 16.5 MB, less than 71.43% of Python3 online submissions for Find Critical and Pseudo-Critical Edges in Minimum Spanning Tree.
    """
