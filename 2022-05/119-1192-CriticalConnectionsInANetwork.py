...
# https://leetcode.com/problems/critical-connections-in-a-network/discuss/2049869/Python-No-"Tarjan"-stuff.-My-own-solution-and-thoughts
# Runtime: 3564 ms, faster than 31.95% of Python3 online submissions for Critical Connections in a Network.
# Memory Usage: 98.5 MB, less than 5.04% of Python3 online submissions for Critical Connections in a Network.
class Solution:
