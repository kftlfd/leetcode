...
class Solution:
    """
    Runtime 811ms Beats 6.23%
    Memory 35.50MB Beats 6.52%
    """

    def findKthBit(self, n: int, k: int) -> str:

        def reverse_invert(s: str) -> str:
